    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-rose-50 via-white to-rose-50">
      <div className="container mx-auto px-6 pt-24 pb-16 lg:flex items-center justify-between relative z-10">
        ...
        <div className="lg:w-1/2 mb-12 lg:mb-0 relative">
          {/* Animated Badge */}
          <div className="inline-flex items-center bg-rose-100 text-rose-700 px-4 py-2 rounded-full mb-6 animate-bounce-slow">
            <RocketIcon className="w-5 h-5 mr-2 text-rose-600" />
          ...
          <h1 className="text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-pink-600 mb-7 leading-tight tracking-tight">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-12">
            <Link
              href="/signup"
              className="bg-rose-500 text-white px-10 py-4 rounded-full text-lg font-semibold 
              hover:bg-rose-600 transition-all duration-300 group flex items-center justify-center 
              shadow-xl shadow-rose-200 hover:shadow-rose-300 hover:-translate-y-1"
            >
            ...
            <Link
              href="/demo"
              className="border-2 border-rose-500 text-rose-700 px-10 py-4 rounded-full 
              text-lg font-semibold hover:bg-rose-50 transition-all duration-300 group 
        ...
        <div className="lg:w-1/2 relative">
          <div className="bg-white rounded-3xl shadow-2xl p-5 transform transition-all duration-300 hover:scale-105 hover:shadow-3xl">
            <div className="bg-gray-100 rounded-2xl overflow-hidden relative">
              {/* Gradient Overlay */}
              <div className="absolute inset-0 bg-gradient-to-r from-rose-500 to-pink-600 opacity-10"></div>
              ...
              <div className="absolute bottom-5 left-5 right-5">
                <div className="bg-white/90 backdrop-blur-md rounded-xl p-4 shadow-lg flex items-center justify-between">
                  <div className="flex items-center">
                    <MessageCircleIcon className="w-8 h-8 text-rose-500 mr-3" />
                    <div>
                  ...
                  <PlayCircleIcon className="w-10 h-10 text-rose-500" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="absolute -top-12 -right-12 bg-white shadow-2xl rounded-full p-4 animate-float">
            <RocketIcon className="w-9 h-9 text-rose-500" />
          </div>
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-0 w-72 h-72 bg-rose-100 rounded-full opacity-50 blur-3xl"></div>
